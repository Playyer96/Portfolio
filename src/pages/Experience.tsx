 ...
 *
 * Displays work and education timeline with filtering
 * Features animated timeline items in alternating left/right layout
 */
          ...
          <div className="experience__timeline-container">
            <AnimatePresence mode="popLayout">
              {filteredExperiences.map((exp, index) => (
                <motion.div
                  key={exp._id || exp.id || `${exp.title}-${exp.date}-${index}`}
